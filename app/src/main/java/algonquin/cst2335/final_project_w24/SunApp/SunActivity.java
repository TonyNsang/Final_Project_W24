...
public class SunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = Room.databaseBuilder(getApplicationContext(), FavoriteLocationDatabase.class, "favorite_locations_db")
        ...
        buttonLookup.setOnClickListener(new View.OnClickListener() {
            ...
            private void performLookup() {
                ...
                if (!latitude.isEmpty() && !longitude.isEmpty()) {
                            ...
                            (Request.Method.GET, apiUrl, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        // Display the results
                                        textViewResults.setText(getString(R.string.sunrise) + sunrise + getString(R.string.sunset) + sunset);
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    // Handle errors
                                    textViewResults.setText(getString(R.string.error_occurred) + error.getMessage());
                                }
                            });
                    ...
                    textViewResults.setText(R.string.please_enter_latitude_and_longitude);
                }
            }
